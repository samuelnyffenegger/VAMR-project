...
[F, inliers_index, status] = estimateFundamentalMatrix(matched_query_keypoints',matched_database_keypoints','Method','RANSAC',...
    'NumTrials',2000,'DistanceThreshold',1e-4);
if status ~= 0
    warning(['estimateFundamentalMatrix did not find enough inlier pairs, only ',num2str(nnz(inliers_index))])
end
